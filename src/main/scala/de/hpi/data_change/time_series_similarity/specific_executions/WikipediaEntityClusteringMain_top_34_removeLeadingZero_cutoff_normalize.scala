...
object WikipediaEntityClusteringMain_top_34_removeLeadingZero_cutoff_normalize extends App with Serializable{
  ...
  clusterer.transformation = List("removeLeadingZero","cutoffAt","normalize")
  ...
  clusterer.aggregationGranularity = 7
  clusterer.seed = 13
