...
object WikipediaEntityClusteringMain_top_34_normalize_kMediod_dtw extends App with Serializable{
  ...
  clusterer.clusteringAlg = "PAMAE"
  clusterer.distanceMeasure = "DTW"
